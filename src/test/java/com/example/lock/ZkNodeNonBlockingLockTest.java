...
public class ZkNodeNonBlockingLockTest {

    @Test
    public void singleThreadTest() {
        ZkNodeNoneBlockingLock locker1 = new ZkNodeNoneBlockingLock("app1");
        ZkNodeNoneBlockingLock locker2 = new ZkNodeNoneBlockingLock("app1");
    ...
    public void multipleThreadTest() throws InterruptedException {
        ...
        for (int i = 0; i < threads.length; i++) {
            threads[i] = new LockThread(new ZkNodeNoneBlockingLock("app2"));
        }
